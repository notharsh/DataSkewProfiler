...
EXPORT KeysKevinBacon := MODULE
  ...
  movie_layout into(test.ActorsInMovies L, UNSIGNED level) := TRANSFORM
    SELF.level := level;
    SELF := L;
  END;

  //Movie set references
  KBMovies := test.KevinBaconNumberSets.KBMovies;
  KBCoStarMovies := test.KevinBaconNumberSets.KBCoStarMovies;
  KBCo2StarMovies := test.KevinBaconNumberSets.KBCo2StarMovies;
  KBCo3StarMovies := test.KevinBaconNumberSets.KBCo3StarMovies;
  KBCo4StarMovies := test.KevinBaconNumberSets.KBCo4StarMovies;
  KBCo5StarMovies := test.KevinBaconNumberSets.KBCo5StarMovies;
  KBCo6StarMovies := test.KevinBaconNumberSets.KBCo6StarMovies; 
  ...
  actor_layout into(test.ActorsInMovies L, UNSIGNED level) := TRANSFORM
    SELF.level := level;
    SELF := L;
  END;

  //Actor set reference
  KBCoStars  := test.KevinBaconNumberSets.KBCoStars;
  KBCo2Stars := test.KevinBaconNumberSets.KBCo2Stars;
  KBCo3Stars := test.KevinBaconNumberSets.KBCo3Stars;
  KBCo4Stars := test.KevinBaconNumberSets.KBCo4Stars;
  KBCo5Stars := test.KevinBaconNumberSets.KBCo5Stars;
  KBCo6Stars := test.KevinBaconNumberSets.KBCo6Stars;
  KBCo7Stars := test.KevinBaconNumberSets.KBCo7Stars;
